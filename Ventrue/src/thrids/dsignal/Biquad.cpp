...
namespace dsignal
{
	void Biquad::Clear()
	{
		...
		f0 = 0;
		BW = 0;
		biquadFilterType = BiquadFilterType::LowPass;
		qtype = QType::Q;
		a0 = 1; a1 = 0; a2 = 0;
		b0 = 1; b1 = 0; b2 = 0;
		x0 = 0; x1 = 0; x2 = 0;
	...
	void Biquad::CalculateCoefficients()
	{
		...
		if (biquadFilterType == BiquadFilterType::PeakingEQ ||
			biquadFilterType == BiquadFilterType::LowShelf ||
			biquadFilterType == BiquadFilterType::HighShelf)
		{

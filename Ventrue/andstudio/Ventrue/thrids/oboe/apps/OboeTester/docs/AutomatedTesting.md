...
The app will run and the results will be written to a file.
    ...
    adb shell am start -n com.google.sample.oboe.manualtest/.cymheart.ventrue.MainActivity {parameters}
...
For example, a complete command for a "latency" test might be:
    ...
    adb shell am start -n com.google.sample.oboe.manualtest/.cymheart.ventrue.MainActivity \
        --es test latency \

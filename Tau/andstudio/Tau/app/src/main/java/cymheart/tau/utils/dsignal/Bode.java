...
public class Bode {
    ...
    //设置滤波器之间是否互相变形绘制
    public void SetFilterBetweenMorphPlot(boolean isMorphPlot)
    {
        ndkSetFilterBetweenMorphPlot(ndkBode, isMorphPlot);
    }
    ...
    //设置增益的偏移DB
    public void SetGainOffsetDB(float offsetGainDB)
    {
        ndkSetGainOffsetDB(ndkBode, offsetGainDB);
    }
    ...
    //获取bode图绘制区域的宽度
    public float GetPlotAreaWidth()
    {
        return ndkGetPlotAreaWidth(ndkBode);
    }

    //获取bode图绘制区域的高度
    public float GetPlotAreaHeigth()
    {
        return ndkGetPlotAreaHeight(ndkBode);
    }
    ...
    private static native void ndkSetFilterBetweenMorphPlot(long ndkBode, boolean isMorphPlot);
    ...
    private static native void ndkSetGainOffsetDB(long ndkBode, float offsetGainDB);
    ...
    private static native float ndkGetPlotAreaWidth(long ndkBode);
    private static native float ndkGetPlotAreaHeight(long ndkBode);

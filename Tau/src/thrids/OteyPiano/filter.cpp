...
namespace oteypiano
{
	...
	*/
	...
	{
		c->x = (float*)new float[2];
		c->y = (float*)new float[2];
		c->a = (float*)new float[2];
		c->b = (float*)new float[2];
	...
	void resonator(float f, float Fs, float tau, Filter* c) {
		c->x = (float*)new float[3];
		c->y = (float*)new float[3];
		c->a = (float*)new float[3];
		c->b = (float*)new float[3];
	...
	*/
	...
	{
		c->x = (float*)new float[N + 1];
		c->y = (float*)new float[N + 1];
		c->a = (float*)new float[N + 1];
		c->b = (float*)new float[N + 1];
